"""Crie um programa onde o usuário poderá escolher se deseja calcular a equação
do 1º grau ou a equação do 2º grau, e o programa retorna o resultado da equação"""
...
if __name__ == "__main__":
    try:
        ...
        print(f"Não foi possível fazer o calculo. {e}.")